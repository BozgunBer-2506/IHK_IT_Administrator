...
Hardware und Rechenleistung mietet man mit **[IaaS]**.
Entwicklerplattformen bietet **[PaaS]**.
Software im Abo heißt **[SaaS]**.
Virtuelle Arbeitsplätze ermöglichen **[DaaS]**.
Speicherlösungen als Dienst nennt man auch **[Cloud‑Speicher]**.
...
3. Geringste Häufigkeiten zu Knoten zusammenfassen
4. Wiederholen, bis nur ein Knoten übrig bleibt
5. Linken Ast mit 0, rechten Ast mit 1 beschriften
6. Codewörter aus dem Baum ablesen
...
3. Änderung ist automatisch für alle Nutzer sichtbar

---

### Frage 22

Öffentlich nutzbar ist die **[Public Cloud]**.
Nur für Unternehmen bestimmt ist die **[Private Cloud]**.
Eine Mischform ist die **[Hybrid Cloud]**.
Eine spezielle Form für Organisationen ist die **[Community Cloud]**.
Lokale Installation wird als **[On‑Premise]** bezeichnet.

---

### Frage 23

Ein Server besitzt eine zentrale **[CPU]**, die alle Berechnungen ausführt.
Der kurzfristige Zwischenspeicher für Daten und Befehle ist der **[RAM]**.
Mehrere Festplatten lassen sich über ein **[RAID]** zu einem logischen Laufwerk verbinden.
Die Kommunikation mit anderen Rechnern ermöglicht die **[Netzwerkkarte]**.
Für die Bildausgabe bei der Erstkonfiguration wird der **[Grafikadapter]** genutzt.

---

### Frage 24

Keine Redundanz kennzeichnet die **[Tier 1]**.
Eine einfache Redundanz beschreibt die **[Tier 2]**.
Fehlertoleranz und Wartbarkeit sind Eigenschaften der **[Tier 3]**.
Vollständige Redundanz bietet die **[Tier 4]**.
Grundlage ist die Norm **[DIN EN 50600]**.

---

### Frage 25

Ein Fat Client ist ein **[leistungsfähiges]** Gerät, das viele Anwendungen **[lokal]** ausführt und über eigene **[Hardware‑Ressourcen]** wie CPU, RAM und Speicher verfügt.
Ein Thin Client ist ein **[einfaches]** Gerät mit minimaler Hardware, das hauptsächlich als **[Schnittstelle]** dient und die Rechenprozesse auf einem Server ausführt.

---

### Frage 26

Die **[Netzwerkkarte]** ist zuständig für den Datenaustausch mit anderen Systemen im Netzwerk.
Der **[Arbeitsspeicher]** dient zur temporären Speicherung und schnellen Verarbeitung von Daten.
Die Anzahl der **[Kerne]** einer CPU beeinflusst die Fähigkeit zur Parallelverarbeitung.
Der **[CPU‑Takt]** bestimmt, wie schnell der Prozessor arbeitet.
Die **[Memory‑Bandbreite]** gibt an, wie schnell Daten zwischen Speicher und CPU übertragen werden können.
**[HDMI]** dient der Audio/Video-Ausgabe, **[Bios‑Passwort]** ist eine Sicherheitsfunktion und **[RJ45]** ist ein Netzwerkteil.

---

### Frage 27

Ein Fat Client ist sehr **[leistungsfähig]**, überträgt Daten meist nur zur Synchronisation und nutzt eigene **[Hardwareressourcen]**.
Ein Thin Client hat nur eine **[minimale Leistung]** und ist auf zentrale Serverdienste angewiesen.
Fat Clients sind oft **[teurer]**, da sie Aufgaben eigenständig ausführen können.
Thin Clients benötigen hingegen oft **[externe Rechenleistung]**, um Anwendungen auszuführen.
Begriffe wie **[optischer Zoom]**, **[GPU‑Taktfrequenz]** und **[Touchscreensteuerung]** sind unzutreffend.
...
Google App Engine bietet skalierbare mobile Back-Ends als Hostingumgebung an.
**Wahr**
...
Die Klassifizierung von Rechenzentren in Tiers basiert auf dem Prinzip, dass jede Stufe eine niedrigere Zuverlässigkeit als die vorherige Stufe bietet.
**Falsch**
...
Cloud-Lösungen erfordern hohe Anschaffungskosten für Server im Vergleich zu On-Premise-Systemen.
**Falsch**
...
Ein Rechenzentrum besteht ausschließlich aus vernetzten Servern.
**Falsch**
